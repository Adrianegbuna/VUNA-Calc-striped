...
describe("evaluateExpression", () => {
  ...
  it("subtracts two numbers", () => expect(evaluateExpression("10-4")).toBe(6));
  it("multiplies two numbers", () =>
    expect(evaluateExpression("6*7")).toBe(42));
  it("divides two numbers", () => expect(evaluateExpression("20/4")).toBe(5));
...
describe("convertUnit - Mass", () => {
  it("converts kg to g", () => expect(convertUnit(1, "kg", "g")).toBe(1000));
...
describe("convertUnit - Data Storage", () => {
  it("converts bytes to bits", () => expect(convertUnit(1, "B", "b")).toBe(8));
  it("converts GB to MB", () => expect(convertUnit(1, "gB", "mB")).toBe(1000));
  it("converts TB to GB", () => expect(convertUnit(1, "tB", "gB")).toBe(1000));
